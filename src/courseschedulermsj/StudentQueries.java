...
public class StudentQueries {
    ...
    public static ArrayList<StudentEntry> getAllStudents() {
        ...
        connection = DBConnection.getConnection();
        try {
            getAllStudents = connection.prepareStatement("select studentid, firstname, lastname from student");
    ...
    public static StudentEntry getStudentID(String studentID) {
        connection = DBConnection.getConnection();
        try {
    ...
    public static void dropStudent(String studentID) {
        connection = DBConnection.getConnection();
        try {
            getAllStudents = connection.prepareStatement("delete from student where studentid = ?");
            getAllStudents.setString(1, studentID);
